...
CREATE TABLE "insight" (
    ...
    "validArticles" INTEGER NOT NULL,
    "duplicatesRemoved" INTEGER NOT NULL,
    "missingContent" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "article" ADD CONSTRAINT "article_searchId_fkey" FOREIGN KEY ("searchId") REFERENCES "search"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "insight" ADD CONSTRAINT "insight_searchId_fkey" FOREIGN KEY ("searchId") REFERENCES "search"("id") ON DELETE CASCADE ON UPDATE CASCADE;
